<template>
  <v-container grid-list-xl>
    <v-layout row justify-center align-center wrap class="m-10 p-10">
      <v-flex xs12 sm12 md6 lg6 xl6>
        <div class="py-4 subheading font-weight-bold">
          <v-icon large color="blue" left>fas fa-map-marker-alt</v-icon>
          <span>Bénin,&nbsp;</span>
          <span class="blue--text">Cotonou</span>
        </div>
        <div class="py-4 subheading font-weight-bold">
          <v-icon large color="blue" left>fas fa-envelope</v-icon>
          <span>parfait.ahouanto@</span>
          <span class="blue--text">imsp-uac.org</span>
        </div>
        <div class="py-4 subheading font-weight-bold">
          <v-icon large color="blue" left>fas fa-phone</v-icon>
          <span>+229&nbsp;</span>
          <span class="blue--text">66 30 11 60</span>
        </div>
        <div class="py-4 subheading font-weight-bold">
      ...
      <v-flex xs12 sm12 md6 lg6 xl6>
        ...
        <form method="POST" action="https://formspree.io/f/meqnjneq">
          <v-text-field
            name="name"
            color="blue"
          ...
          <v-btn
            ...
            >SEND MESSAGE</v-btn
          >
          <v-btn color="#ff042ec2" class="white--text" @click="clear"
            >clear</v-btn
          >
        </form>
      </v-flex>
...
export default {
  metaInfo: {
    ...
    meta: [
      ...
      {
        name: "description",
        content: "Parfait 's Contact Freelance Get in Touch ContactMe",
      },
      { charset: "utf-8" },
      ...
      },
      {
        ...
        content:
          "Parfait 's Contact Doboj Bosnia and Herzegovina Freelance Get in Touch ContactMe",
      },
    ],
  },
